        ...
        <table class="table table-striped">
            ...
            <?php foreach($product as $row):?>
                ...
                <td><?php echo $row['product_name'];?></td>
                    ...
                    <td><?php echo isset($row['product_category_id']);?></td>
                    <td>
                    <a href="#" class="btn btn-info btn-sm btn-edit" data-id="<?=$row['product_id'];?>" data-name="<?=$row['product_name'];?>" data-price="<?=$row['product_price'];?>" data-category="<?php echo isset($row['category_name']);;?>">Edit</a>
